// English-UI screenshot capture for the English README. Not part of the app.
// Same as shots.mjs but seeds English demo tasks and writes to docs/screenshots/en.
// Pair it with a temporary English pass over the UI strings, then revert.
// Run: node scripts/shots-en.mjs
import puppeteer from "puppeteer-core";

const CHROME =
  "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome";
const BASE = "http://localhost:4318";
const OUT = "docs/screenshots/en";
...
const demo = {
  state: {
    ...
    tasks: [
      mk("d1", "Message 10 potential users", 1, 3, 1, false, { revenue: true }),
      mk("d2", "Write the landing page v1", 2, 2, 0, false, {
        product: true,
        deep: true,
        morning: true,
      }),
      mk("d3", "Record a 90-sec product demo", 3, 2, 0, false, { product: true }),
      mk("d4", "Reply to this week's user feedback", 4, 1, 1, true, {}),
      mk("d5", "Sketch next week's plan", 5, 1, 0, false, { optional: true }),
    ],
    planConfirmed: true,
    aiSource: "ai",
    today: {
